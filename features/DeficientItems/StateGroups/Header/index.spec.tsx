...
describe('Unit | Features | Deficient Item List | State Item Header', () => {
  it('should render completed state title', () => {
    ...
    render(<StateItemHeader state="completed" itemCount={1} />);
  ...
  it('should render incomplete state title', () => {
    ...
    render(<StateItemHeader state="incomplete" itemCount={1} />);
  ...
  it('should render overdue state title', () => {
    ...
    render(<StateItemHeader state="overdue" itemCount={1} />);
  ...
  it('should render requires-action state title', () => {
    ...
    render(<StateItemHeader state="requires-action" itemCount={1} />);
  ...
  it('should render go-back state title', () => {
    ...
    render(<StateItemHeader state="go-back" itemCount={1} />);
  ...
  it('should render requires-progress-update state title', () => {
    ...
    render(<StateItemHeader state="requires-progress-update" itemCount={1} />);
  ...
  it('should render deferred state title', () => {
    ...
    render(<StateItemHeader state="deferred" itemCount={1} />);
  ...
  it('should render pending state title', () => {
    ...
    render(<StateItemHeader state="pending" itemCount={1} />);
  ...
  it('should render closed state title', () => {
    ...
    render(<StateItemHeader state="closed" itemCount={1} />);
  ...
  it('should render overdue state title with plural', () => {
    ...
    render(<StateItemHeader state="overdue" itemCount={2} />);
  ...
  it('should render requires-action state title with plural', () => {
    ...
    render(<StateItemHeader state="requires-action" itemCount={2} />);
  ...
  it('should render go-back state title with plural', () => {
    ...
    render(<StateItemHeader state="go-back" itemCount={2} />);
  ...
  it('should render requires-progress-update state title with plural', () => {
    ...
    render(<StateItemHeader state="requires-progress-update" itemCount={2} />);
