  ...
  <li className={styles.container}>
    <div className={styles.container__left}>
      ...
      <div className={styles.title}>
        {resident.firstName && (
          <span data-testid="residents-first-name">{resident.firstName}</span>
        )}
        {resident.middleName && (
          <span data-testid="residents-middle-name">{resident.middleName}</span>
        )}
        {resident.lastName && (
          <span data-testid="residents-last-name">{resident.lastName}</span>
        )}
      </div>
      {resident.id && (
