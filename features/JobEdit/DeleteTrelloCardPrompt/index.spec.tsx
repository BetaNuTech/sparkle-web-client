...
describe('Unit | Features | Job Edit | Delete Trello Card Prompt', () => {
  afterEach(() => sinon.restore());

  it('invokes on confirm action on confirm clicked', () => {
    const expected = true;
    ...
    const confirmButton = screen.queryByTestId('btn-confirm-delete-trello');
