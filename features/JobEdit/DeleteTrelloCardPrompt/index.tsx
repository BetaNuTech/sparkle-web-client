...
const DeleteTrelloCardPrompt: FunctionComponent<Props> = ({ ...props }) => {
  ...
  return (
    <>
      <header className={styles.modalPrompt__header}>
        ...
        <h5 className={styles.modalPrompt__heading}>Delete Trello Card</h5>
      </header>

      <div className={styles.modalPrompt__main}>
        <div className={styles.modalPrompt__main__content}>
          <p className={styles.modal__description}>
            Are you sure you&apos;d like to delete this trello card from this
            job?
          </p>
        </div>
        ...
        <footer className={styles.modalPrompt__main__footer}>
          ...
          <button
            ...
            data-testid="btn-confirm-delete-trello"
          >
            Confirm Delete
          </button>
        </footer>
...
export default Modal(DeleteTrelloCardPrompt, true);
